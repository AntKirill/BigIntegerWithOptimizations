...
static const uint32_t base = (uint32_t) (1 << 31) - 1;
static const int64_t actualBase = (int64_t) base + 1;
...
big_integer &big_integer::operator=(big_integer const &other) {
    ...
    if (number.size() == 1 && number.back() == 0) sign = true;
...
big_integer &big_integer::operator=(int64_t other) {
    big_integer a(other);
    *this = a;
    return *this;
}
